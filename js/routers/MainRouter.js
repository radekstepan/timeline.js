...
App.Routers.Main = Backbone.Router.extend({
    ...
    initialize: function(options) {
    	...
    	var entries = [
    		{ 'label': 'Gym', 'timestamp': 1322611200, 'text': 'Did cardio', 'type': 'blue' },
            { 'label': 'Gym', 'timestamp': 1322611200, 'text': 'Got a pump', 'type': 'red' },
            { 'label': 'Gym', 'timestamp': 1325289600, 'text': 'Body is sore', 'type': 'blue' },
            { 'label': 'Nutrition', 'timestamp': 1322611200, 'text': 'Read Guide', 'type': 'green' },
